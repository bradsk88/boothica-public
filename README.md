...
ln -sfn $BASE_DIR/public/newbooth/ /srv/http/newbooth 
...
ln -sfn $BASE_DIR/public/actions /srv/http/actions
ln -sfn $BASE_DIR/public/action-pages /srv/http/action-pages
