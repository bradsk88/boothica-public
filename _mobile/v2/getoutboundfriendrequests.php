...
class GetIgnoredFriendRequestResponse extends AbstractUserApiResponse {
    ...
    protected function run($username) {
        $sqlBuilder = new h2o("{$_SERVER['DOCUMENT_ROOT']}/_mobile/v2/queries/getOutboundFriendRequests.mst.sql");
        ...
        $this->markCallAsSuccessful("Outbound friend requests get OK", array("requests" => $requests));
