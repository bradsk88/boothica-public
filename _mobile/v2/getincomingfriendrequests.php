...
class GetIncomingFriendRequestResponse extends AbstractUserApiResponse {

    protected function run($username)
    {
        $sqlBuilder = new h2o("{$_SERVER['DOCUMENT_ROOT']}/_mobile/v2/queries/getIncomingFriendRequests.mst.sql");
        ...
        $this->markCallAsSuccessful("Friend requests get OK", array("requests" => $requests));

    }
}

$response = new GetIncomingFriendRequestResponse();
$response->runAndEcho();
